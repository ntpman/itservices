	...
	<div class="col-md-12">
		<div class="card">
                        ...
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-labJuly" role="tabpanel" aria-labelledby="custom-tabs-four-labJuly-tab">
                                ...
                                <div class="d-flex flex-row justify-content-center">
                                    ...
                                    <span class="mr-2">
                                        <a href="/bstiadmin-questionnaire/{{$lab->user_id}}/send" class="btn btn-outline-primary btn-sm">
            ...
            <div class="card-footer">
                <a href="/bstiadmin-questionnaire" class="btn btn-secondary btn-sm">
...
<div class="modal fade" id="modal-upload" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="/bstiadmin-questionnaire" method="POST" enctype="multipart/form-data" role="form">
                @csrf
...
@section('scripts')
    <script src="{{ asset('js/bstiadmin/form-modal.js') }}"></script>
@endsection
