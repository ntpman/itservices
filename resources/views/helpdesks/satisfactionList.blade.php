        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">แบบสั่งซ่อม/ทำสิ่งของที่รอการประเมินความพึงพอใจ</h3>
                        ...
                        @if (count($requestInfos) > 0)
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center" width="150px">บันทึกความพึงพอใจ</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($requestInfos as $item)                                  
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="/helpdesk/satisfactionRecord/{{$item->id}}" class="btn btn-info btn-xs"> <i class="fas fa-smile"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
