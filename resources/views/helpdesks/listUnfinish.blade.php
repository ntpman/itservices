        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">แบบสั่งซ่อม/ทำสิ่งของ (F-CD0-071) ที่ยังไม่แล้วเสร็จ</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body table-responsive">
                    <table id="allRequest" class="table table-bordered table-striped table-sm datatables">
                        @if (count($requestUnfinishs) > 0)
                            <thead>
                                <tr>
                            ...
                            <tbody id="items">
                                @foreach ($requestUnfinishs as $item)                                  
                                    <tr>
