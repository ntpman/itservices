            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title"><i class="far fa-edit"></i>บันทึกข้อมูลการรับแจ้งปัญหาทางโทรศัพท์ หรืออีเมล์</h3>
                    </div>
                    <!-- form start -->
                    {!! Form::open(['action' => 'Helpdesks\OnCallController@store', 'method' => 'POST', 'class' => 'was-validate','enctype'=>'multipart/form-data']) !!}
