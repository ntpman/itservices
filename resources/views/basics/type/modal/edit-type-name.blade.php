<div class="modal fade" id="modal-typeName" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="far fa-edit"></i> Edit Type Name</h4>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <input type="hidden" name="edit-typeName" value="1">
