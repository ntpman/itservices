            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header ui-sortable-handle" style="cursor: move;">
                        <h3 class="card-title">All Brand Models รุ่นของผลิตภัณฑ์</h3>
                        <div class="card-tools">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link active" href="/basics/brandmodel/create"><i class="fas fa-plus"></i> เพิ่มข้อมูล</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            @if (count($showAllBrandModel) > 0)
                                ...
                                @foreach ($showAllBrandModel as $brandModel)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/basics/brandmodel/{{ $brandModel->id }}/edit" class="bth btn-info btn-sm">
