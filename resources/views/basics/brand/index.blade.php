            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header ui-sortable-handle" style="cursor: move;">
                        <h3 class="card-title">All Brands ยี่ห้อผลิตภัณฑ์</h3>
                        <div class="card-tools">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link active" href="/basics/brand/create"><i class="fas fa-plus"></i> เพิ่มข้อมูล</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            @if (count($showAllBrand) > 0)
                                ...
                                @foreach ($showAllBrand as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/basics/brand/{{ $brand->id }}/edit" class="bth btn-info btn-sm">
