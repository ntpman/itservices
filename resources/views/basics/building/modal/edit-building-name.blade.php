<div class="modal fade" id="edit-buildingName" data-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    {{ Form::text('buildingName', $editBuilding->building_name, ['class' => 'form-control','required']) }}
                </div>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
                <input type="hidden" name="edit-buildingName" value="1">
