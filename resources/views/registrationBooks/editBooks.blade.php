...
@section('page_name')
    | แก้ไขข้อมูลการลงทะเบียนรับหนังสือ
@endsection
...
<div class="container">
    ...
    <div class="col col-md-12">
      <div class="card card-primary card-outline">
          <div class="card-header">
              <h3 class="card-title">แก้ไขข้อมูลหนังสือรับ เลขที่ {{ $books->books_no }}</h3>
  ...
  <div class="row">
    <div class="col col-sm-10 col-md-12" style="margin-top: 0.5px">
      <div class="card">
        <div class="card-body">
          {!! Form::open(['action' => 'RegistrationBooksController@editBooks', 'method' => 'POST', 'class' => 'was-validate','enctype'=>'multipart/form-data']) !!}
          <div class="row">
