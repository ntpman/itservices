            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header ui-sortable-handle" style="cursor: move;">
                        <h3 class="card-title">All Common</h3>
                        <div class="card-tools">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link active" href="/basic/common/create"><i class="fas fa-edit"></i>เพิ่มข้อมูล</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            @if (count($showAllCommon) > 0)
                                ...
                                @foreach ($showAllCommon as $common)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/basic/common/{{ $common->id }}/edit" class="bth btn-primary btn-sm">
