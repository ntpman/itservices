                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            {{ Form::select('brandFullName', $allBrand, $editModel->brand_id, ['class' => 'form-control', 'disabled']) }}
                        </div>
                        <div class="form-group">
							{{ Form::label('title','ชื่อรุ่นผลิตภัณฑ์')}}
							{{ Form::text('modelName', $editModel->model_name, ['class' => 'form-control','disabled']) }}
                        </div>
                        <div class="form-group">
                            ...
                            {{ Form::select('modelStatus', [
                                    'A' => 'Active',
                                    'D' => 'Disable',
                                ], $editModel->model_status, ['class'=>'form-control']) 
                            }}
                        </div>
