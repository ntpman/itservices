                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            {{ Form::select('typeName', $allType, $editSubType->asset_type_id, ['class' => 'form-control', 'disabled']) }}
                        </div>
                        <div class="form-group">
							{{ Form::label('title','ชื่อรุ่นผลิตภัณฑ์')}}
							{{ Form::text('subTypeName', $editSubType->subtype_name, ['class' => 'form-control','disabled']) }}
                        </div>
                        <div class="form-group">
