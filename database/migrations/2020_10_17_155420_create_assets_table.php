...
class CreateAssetsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('assets', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('asset_subtype_id')->comment('รหัสประเภทครุภัณฑ์ย่อย');
            $table->unsignedBigInteger('common_name_id')->comment('รหัสชื่อครุภัณฑ์');
            ...
            $table->unsignedBigInteger('model_id')->comment('รหัสรุ่นครุภัณฑ์');
            $table->string('serial_number',1)->comment('หมายเลขประจำเครื่อง');
            ...
            $table->foreign('common_name_id')->references('id')->on('asset_common_names');
        });
    }
